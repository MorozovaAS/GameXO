...
for i in range(1, len(position)+1):
    if i % 2 != 0:
        p = int(input('X - Выберите позицию: '))
        while p > 9 or p < 0:
            p = int(input('X - Выберите другую позицию от 1 до 9: '))
        while position[p-1] == 'X' or position[p-1] == 'O':
            p = int(input('X - Выберите другую позицию, эта занята: '))  
        position[p-1] = 'X'
        print()
        print(" ", position[0] ," ", "|"," ", position[1], " ", "|", " ", position[2]," ")
        print("-" * 21)
        ...
        p = int(input('O - Выберите позицию: '))
        while p > 9 or p < 0:
            p = int(input('O - Выберите другую позицию от 1 до 9: '))
        while position[p-1] == 'X' or position[p-1] == 'O':
            p = int(input('O - Выберите другую позицию, эта занята: '))
        position[p-1] = 'O'
        print()
        print(" ", position[0] ," ", "|"," ", position[1], " ", "|", " ", position[2]," ")
        print("-" * 21)
